...
<body>
	...
	<div class="header1">
			...
			<div class="col-2" align="center">
			<a href="leaveApply.jsp">LEAVE APPLICATION</a>
			</div>
			
			<div class="col-2" align="center">
			<a href="CompanyMaintenanceSystem.php"><img src="Header _ Footer/Camera.png" style="height:25%;width:25%"></a>
			</div>
			<div class="col-2" align="center">
			<a href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">NOTIFICATIONS</a>
			</div>
			<div class="col-2" align="center">
			<%
